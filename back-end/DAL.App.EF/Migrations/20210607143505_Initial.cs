        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizOrPoll = table.Column<string>(type: "nvarchar(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quizzers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Quizzers_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Quizzers_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizzerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizzerAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizzerAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuizzerAnswers_Quizzers_QuizzerId",
                        column: x => x.QuizzerId,
                        principalTable: "Quizzers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizzerAnswers_AnswerId",
                table: "QuizzerAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizzerAnswers_QuizzerId",
                table: "QuizzerAnswers",
                column: "QuizzerId");

            migrationBuilder.CreateIndex(
                name: "IX_Quizzers_AppUserId",
                table: "Quizzers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Quizzers_QuizId",
                table: "Quizzers",
                column: "QuizId");
