<template>
    <header>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
            <div class="container">
                <router-link class="navbar-brand" to="/">quizzy.</router-link>
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                    <ul class="navbar-nav flex-grow-1">
                        <li class="nav-item">
                            <router-link class="nav-link text-dark" to="/quizzes">Quizzes</router-link>
                        </li>
                        <li class="nav-item">
                        ...
                        <li v-if="role === 'Admin'" class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <router-link class="nav-link text-dark" to="/answers">Answers</router-link>
                                <router-link class="nav-link text-dark" to="/questions">Questions</router-link>
                                <router-link class="nav-link text-dark" to="/quizzes">Quizzes</router-link>
                                <router-link class="nav-link text-dark" to="/quizzers">Quizzers</router-link>
                                <router-link class="nav-link text-dark" to="/quizzer-answers">Quizzer Answers</router-link>
...
html, #app {
    ...
    background: linear-gradient(90deg, rgba(0,224,255,1) 0%, rgba(255,53,165,1) 100%);
